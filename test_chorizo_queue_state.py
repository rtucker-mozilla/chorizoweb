...
class testChorizoQueueState(unittest.TestCase):
    ...
    def test4_add_host_to_group_if_not_exists(self):
    	...
    	self.cqs.add_host_to_group_if_not_exists(group_name, host_name)
    	self.assertTrue(len(self.cqs.running_group_updates) == 1)
    	...
    	self.cqs.add_host_to_group_if_not_exists(group_name, host_name2)
    	...
    	self.cqs.add_host_to_group_if_not_exists(group_name, host_name3)
    ...
    def test5_add_script_to_host_group(self):
    	...
    	self.cqs.add_host_to_group_if_not_exists(group_name, host_name)
    	self.cqs.add_script_to_host_group(script_name, host_name, group_name)
    ...
    def test7_get_next_script_to_run(self):
    	...
    	self.cqs.add_host_to_group_if_not_exists(group_name, host_name)
    	self.cqs.add_script_to_host_group(script_name, host_name, group_name)
    	self.cqs.add_script_to_host_group(script_name2, host_name, group_name)
    ...
    def test10_check_group_done(self):
    	...
    	script_name = 'test-script.sh'
    	self.cqs.add_host_to_group_if_not_exists(group_name, host_name)
    	self.cqs.add_host_to_group_if_not_exists(group_name2, host_name2)
    ...
    #def test11_get_next_host(self):
    	...
    	#self.cqs.add_host_to_group_if_not_exists(group_name, host_name)
    	#self.cqs.add_host_to_group_if_not_exists(group_name2, host_name2)
    	#self.assertEqual(self.cqs.get_next_host_by_group(group_name), host_name)
